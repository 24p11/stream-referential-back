...
import static fr.aphp.referential.load.domain.type.list.f003.ListMetadataType.AUTHOR;
...
import static fr.aphp.referential.load.domain.type.list.f003.ListMetadataType.VERSION;
...
public class ListMetadataProcessor implements MetadataProcessor {
    ...
    public Stream<MetadataMessage> metadataMessageStream(Message message) {
        ...
        MetadataContentBean metadataContentBean = MetadataContentBean.builder()
                ...
                .device(listMessage.getDevice())
                .organ(listMessage.getOrgan())
                .build();
