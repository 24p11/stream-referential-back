...
import fr.aphp.referential.load.processor.list.f003.ListProcessor;
...
@Component(LIST_F003_ROUTE_ID)
public class ListRoute extends BaseRoute {
    public ListRoute() {
        setInput(direct(LIST_F003_ROUTE_ID));
