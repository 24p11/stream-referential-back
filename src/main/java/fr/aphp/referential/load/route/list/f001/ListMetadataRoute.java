...
import static fr.aphp.referential.load.util.CamelUtils.LIST_F001_METADATA_ROUTE_ID;
import static fr.aphp.referential.load.util.CamelUtils.TO_DB_METADATA_ROUTE_ID;

@Component(LIST_F001_METADATA_ROUTE_ID)
public class ListMetadataRoute extends BaseRoute {
    ...
    public ListMetadataRoute(ListMetadataProcessor listMetadataProcessor) {
        ...
        setInput(direct(LIST_F001_METADATA_ROUTE_ID));
    ...
    public void configure() throws Exception {
        ...
        from(getInput())
                .routeId(LIST_F001_METADATA_ROUTE_ID)
